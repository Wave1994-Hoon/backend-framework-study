package com.study.chapter5.transaction;
...
public abstract class Transaction {
    ...
    PreparedStatement prepareStatement(String SQL) throws SQLException, NamingException {
    ...
    Statement createStatement() throws SQLException, NamingException {
        Connection connection = getConnection();
